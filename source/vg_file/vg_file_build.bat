...
set DefaultBuildDirectory=..\..\source\vg_file\build\
...
cl %ReleaseCompilerFlags% %DefaultSourceDirectory%vg_file.c /I %DefaultIncludeDirectory% /link %DefaultLinkerflags% /libpath:%DefaultLibDirectory%
lib vg_file.obj
