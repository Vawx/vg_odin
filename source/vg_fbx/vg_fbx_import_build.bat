...
set DefaultBuildDirectory=..\..\source\vg_fbx\build\
...
set DebugCompilerFlags=%DefaultCompilerFlags% %DisableOptimizations% %MultithreadExecDebug% %WarningLevelStrict% %WarningAsError% %GenerateVersion7Debugging% 
...
cl %ReleaseCompilerFlags% %DefaultSourceDirectory%vg_fbx_import.c /I %DefaultIncludeDirectory% /link %DefaultLinkerflags% /libpath:%DefaultLibDirectory%
lib vg_fbx_import.obj
