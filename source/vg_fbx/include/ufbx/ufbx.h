...
#define UFBX_DLL_EXPORT extern __declspec(dllexport) 
...
extern __declspec(dllexport) ufbx_scene *ufbx_load_file(const char *filename, const ufbx_load_opts *opts, ufbx_error *error);
...
UFBX_DLL_EXPORT void ufbx_free_scene(ufbx_scene *scene);
...
UFBX_DLL_EXPORT ufbx_matrix ufbx_matrix_for_normals(const ufbx_matrix *m);
...
UFBX_DLL_EXPORT uint32_t ufbx_triangulate_face(uint32_t *indices, size_t num_indices, const ufbx_mesh *mesh, ufbx_face face);
...
UFBX_DLL_EXPORT size_t ufbx_generate_indices(const ufbx_vertex_stream *streams, size_t num_streams, uint32_t *indices, size_t num_indices, const ufbx_allocator *allocator, ufbx_error *error);
