...
extern "C" {
    ...
    DLL_EXPORT void sfetch_setup(const sfetch_desc_t* desc);
    /* discard a sokol-fetch context */
    DLL_EXPORT void sfetch_shutdown(void);
    ...
    DLL_EXPORT sfetch_handle_t sfetch_send(const sfetch_request_t* request);
    ...
    DLL_EXPORT void sfetch_dowork(void);
    ...
    DLL_EXPORT void sfetch_pause(sfetch_handle_t h);
    /* continue a paused request */
    DLL_EXPORT void sfetch_continue(sfetch_handle_t h);
